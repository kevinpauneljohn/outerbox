...
//    this method will check the new leads in leads table
    ...
    private function create_ticket($lead_id, $call_center_id, $agent_id)
    {
        $ticket = new Ticket;
...
//            }
//        }
        $address = 'blk 141 lot 2, ANGELES CITY, PAMPANGA, REGION III (CENTRAL LUZON)';
        return $this->get_all_local_call_center($address);
    }
}
